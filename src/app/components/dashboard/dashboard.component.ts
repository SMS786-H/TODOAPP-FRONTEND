...
export class DashboardComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.taskForm.valid) {
      ...
      this.http.post<any>('https://todoapp-backend-i8km.onrender.com/api/todos/createtask', taskData, { headers }).subscribe(
        response => {
  ...
  getTasks(): void {
    ...
    this.http.get<any>('https://todoapp-backend-i8km.onrender.com/api/todos/gettask', { headers }).subscribe(
      response => {
        console.log(response);
  ...
  deleteTask(taskId: string): void {
    ...
    this.http.delete<any>(`https://todoapp-backend-i8km.onrender.com/api/todos/deletetask/${taskId}`, { headers }).subscribe(
      response => {
        console.log(response);
  ...
  markAsComplete(taskId: string): void {
    ...
    this.http.patch<any>(`https://todoapp-backend-i8km.onrender.com/api/todos/edittask/${taskId}`, { status: true }, { headers }).subscribe(
      response => {
        console.log(response);
        alert(response.message)
  ...
  markAsImportant(taskId: string): void {
    ...
    this.http.patch<any>(`https://todoapp-backend-i8km.onrender.com/api/todos/edittask/${taskId}`, { important: true }, { headers }).subscribe(
      response => {
        console.log(response);
        alert(response.message)
