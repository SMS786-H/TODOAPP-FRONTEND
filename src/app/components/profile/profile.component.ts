...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todoapp-backend-i8km.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todoapp-backend-i8km.onrender.com/api/todos/deleteuser'
